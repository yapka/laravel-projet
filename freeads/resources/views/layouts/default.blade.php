...
<body class="pt-10 pb-16 antialiased md:pb-32">
    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <header class="flex items-center justify-between space-x-5 text-slate-900">
            ...
            <form action="{{ route('index') }}" class="flex items-center pb-3 pr-2 transition border-b border-b-slate-300 text-slate-300 focus-within:border-b-slate-900 focus-within:text-slate-900">
